...
* CLI Enhancements
    ...
    * [thumbnails](https://github.com/pysnippet/thumbnails) - Video thumbnail generator for modern web video players such as Plyr, Videojs, Flowplayer, Fluid Player, etc.
