...
* [pydot](https://github.com/pydot/pydot) - Used for generating complex oriented/non-oriented graphs.
...
- [Problem Solving with Algorithms and Data Structures Using Python SECOND EDITION](http://www.openbookproject.net/books/pythonds/)
